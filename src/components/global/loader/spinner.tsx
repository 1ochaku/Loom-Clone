    ...
    return (
      <div role="status">
        ...
        >
          ...
          />
          <path
            d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9115 97.0079 
               33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 
               15.1192 80.8826 10.7234 75.2124 7.41289C69.5422 4.10237 63.2754 
               ...
               9.54855 51.7191 9.52689 55.5402 10.0491C60.864 10.7766 65.9928 
               12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 
               82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 
               35.8758C89.0833 38.2158 91.5411 39.6781 93.9676 
               39.0409Z"
            fill={color || "#fff"}
          />
        </svg>
